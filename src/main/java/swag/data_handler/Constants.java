...
public class Constants {
	...
	public final static String MEASURE_E = "measure";
	public final static String OP_RESULT_FILTER_PROP_E = "opResultSelection";
	public final static String OP_MEASURE_SELECTION_PROP_E = "opMeasureSelection";
	public final static String OP_SLICE_COND_PROP_E = "opDimensionPredicate";
	...
	public final static String RollUpToOpClass = "RollUpToLevel";
	public final static String DrillDownOpClass = "DrillDown";
	public final static String DrillDownToOpClass = "DrillDownToLevel";
	public final static String OP_TO_GRANULARITY = "opToGranularity";
	public final static String MoveToDiceNodeOpClass = "MoveToDiceNode";
	public final static String navToDiceValue = "opHasDiceNode";
	public final static String AddDimensionSelectionOperator = "AddDimensionSelection";
	public final static String AddDimTypedConditoinOperator = "AddTypedDimensionSelectoin";
	public final static String AddResultSelectionOperator = "AddResultSelection";
	public final static String AddBaseMeasureSeletionOperator = "AddBaseMeasureSelection";
	public final static String MoveDownToDiceNodeOpClass = "MoveDownToDiceNode";
	public final static String MoveUpToDiceNodeOpClass = "MoveUpToDiceNode";
	public final static String MoveToNextDiceNodeOpClass = "MoveToNextDiceNode";
	public final static String MoveToPrevDiceNodeOpClass = "MoveToPreviousDiceNode";
	public final static String AddMeasureOpClass = "AddMeasure";
	public final static String navMeasureToAS = "navMeasureToAS";
	public final static String ModifySliceConditionOpClass = "RefocusSliceCondition";
	public final static String ChangeSliceOpClass = "ChangeSlice";
	public final static String RefocusSliceConditionOpClass = "RefocusSliceCondition";
