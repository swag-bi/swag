  ...
  public final static String LITERAL_CONDITION_TYPES =
      "PREFIX pr: <http://www.amcis2021.com/swag/pr#>"
          ...
          + " {"
            ...
            + " UNION { ?literalConditionType rdf:type ag:MDPredicate } "
            + " UNION { ?literalConditionType rdf:type ag:DimensionPredicate } "
            + " UNION { ?literalConditionType rdf:type ag:MeasurePredicate } "
            + " UNION { ?literalConditionType rdf:type ag:ResultPredicate } "
            + " } "
  ...
  public final static String LITERAL_CONDITIONS =
      "PREFIX pr: <http://www.amcis2021.com/swag/pr#>"
          ...
          + " {"
            ...
            + " UNION { ?literalConditionType rdf:type ag:GroundMeasurePredicate } "
