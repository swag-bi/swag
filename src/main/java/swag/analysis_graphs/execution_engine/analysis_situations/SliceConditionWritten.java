...
public class SliceConditionWritten<T extends ISignatureType> implements ISliceSinglePositionTyped<T> {
    ...
    public SliceConditionWritten() {
	super();
	initiateIfNull(null, null);
    }

    public SliceConditionWritten(MDElement pos, String cond) {
	initiateIfNull(cond, null);
	this.condition = cond;
	this.positionOfCondition = pos;
    }

    public SliceConditionWritten(MDElement pos, String cond, String type) {
    ...
    public SliceConditionWritten(Signature<T> signature) {
	this.signature = signature;
    }

    public SliceConditionWritten(MDElement pos, String cond, Signature<T> signature) {
	this(pos, cond);
	this.signature = signature;
    }

    public SliceConditionWritten(MDElement pos, String cond, String type, Signature<T> signature) {
	this(pos, cond, type);
	this.signature = signature;
    }
     ...
     * 
     */
    private SliceConditionWritten(SliceConditionWritten<T> pred) {
	...
	if (o instanceof SliceConditionWritten) {
	    SliceConditionWritten<T> sc = (SliceConditionWritten<T>) o;
	...
	SliceConditionWritten<T> sc = (SliceConditionWritten<T>) sourceVar;
	...
	SliceConditionWritten<T> sc = (SliceConditionWritten<T>) tempVariable;
	this.setCondition(sc.getCondition());
	...
	return new SliceConditionWritten<T>(this);
    }
	...
	return new SliceConditionWritten<T>(getPositionOfCondition(), getCondition(), getType(),
