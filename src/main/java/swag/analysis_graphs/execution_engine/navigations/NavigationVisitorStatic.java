...
/**
 * 
 * Only substitutes values in target situation - No dynamic navigation except
 * for loops
 * 
 * @author swag
 *
 */
public class NavigationVisitorStatic implements IOperatorVisitor {

    private static final Logger logger = Logger.getLogger(NavigationVisitorStatic.class);
    ...
    public NavigationVisitorStatic(AnalysisSituation src, AnalysisSituation des, MDSchema schema, IMDSchemaDAO mdDao,
